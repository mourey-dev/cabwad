    ...
    <form className="mx-auto my-12 grid h-full w-[1001px] border-2">
      ...
      <div className="grid grid-cols-5">
        ...
        <div className="col-span-1 grid grid-cols-2 border-2 p-2">
          <div className="flex gap-1">
            <input type="checkbox" id="personal_civil_single" />
            <label htmlFor="personal_civil_single">Single</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" id="personal_civil_married" />
            <label htmlFor="personal_civil_married">Married</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" id="personal_civil_widowed" />
            <label htmlFor="personal_civil_widowed">Widowed</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" id="personal_civil_separated" />
            <label htmlFor="personal_civil_separated">Separated</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" id="personal_civil_other" />
            <label htmlFor="personal_civil_other">Other/s:</label>
          </div>
        </div>

        <div className="col-span-3 row-span-3 grid grid-cols-4 grid-rows-5">
          <span className="col-span-1 row-span-4 border-2 border-b-0 text-[.7rem] tracking-tighter">
            &nbsp;17. RESIDENTIAL ADDRESS
          </span>
          <div className="col-span-3 row-span-4 grid">
            <div className="relative border-2">
              <input type="text" id="ra_house" className="w-[50%] border-b-2" />
              <label
                htmlFor="ra_house"
            ...
            <div className="relative border-2">
              <input type="text" id="ra_city" className="w-[50%] border-b-2" />
              <label
                htmlFor="ra_city"
                className="absolute bottom-0 left-15 text-[.7rem]"
              >
          ...
          <label
            htmlFor="ra_zip"
            className="col-span-1 border-2 border-t-0 text-center tracking-tighter"
          >
            Zip Code
          </label>
          <input type="text" id="ra_zip" className="col-span-3 border" />
        </div>
        ...
        <div className="col-span-3 row-span-4 grid grid-cols-4 grid-rows-5">
          ...
          <div className="col-span-3 row-span-4 grid">
            <div className="relative border-2">
              <input type="text" id="pa_house" className="w-[50%] border-b-2" />
              <label
                htmlFor="pa_house"
                className="absolute bottom-0 left-15 text-[.7rem]"
              >
          ...
          <input type="text" id="pa_zip" className="col-span-3 border" />
        </div>
      ...
      <div className="grid grid-cols-5">
        ...
        <div className="col-span-2 grid grid-cols-3">
          <span className="col-span-2 block border-2 text-[.8rem] tracking-tighter">
        ...
        <div className="col-span-2 grid grid-cols-3">
          <input
            ...
            className="col-span-2 border-2 p-2"
          />
          <div className="relative col-span-1 border-2">
            <label
              htmlFor="spouse_name_extension"
              className="absolute pl-1 text-[.5rem] tracking-tighter"
            >
              NAME EXTENSION (JR., SR)
            </label>
        ...
        <label
          ...
          className="col-span-1 border-2 text-[.9rem] tracking-tighter"
        >
        ...
        <label
          ...
          className="col-span-1 border-2 border-b-0 text-[.9rem] tracking-tighter"
        >
        ...
        <span className="col-span-2 py-2 text-center text-red-600">
      ...
      <div className="grid grid-cols-5">
        ...
        <span className="col-span-1 border-2 border-t-0 text-center tracking-tighter">
          NAME OF SCHOOL
          <span className="block">(Write in full)</span>
        </span>
        <span className="col-span-1 border-2 border-t-0 text-center text-[.8rem] tracking-tighter">
        ...
        <div className="col-span-2 grid grid-cols-5">
          <div className="col-span-2 grid grid-cols-2 grid-rows-2">
            <span className="col-span-2 row-span-1 border-b-2 text-center text-[.7rem]">
              PERIOD OF ATTENDANCE
            </span>
            <span className="col-span-1 row-span-1 border-r-2 text-center text-[.7rem]">
              FROM
            </span>
          ...
          <span className="col-span-1 border-x-2 text-center text-[.7rem]">
            HIGHEST LEVEL/ UNITS EARNED
          </span>
          <span className="col-span-1 border-r-2 text-center text-[.7rem]">
            YEAR GRADUATED
          </span>
          <span className="col-span-1 text-center text-[.7rem]">
