  ...
  <div  className="min-h-screen bg-blue-600 text-black flex flex-col">
    ...
    <form className="mx-auto my-12 grid h-full w-[1001px] border-4 bg-white" onSubmit={handleSubmit(onSubmit)}>
      <div className="grid grid-cols-5">
        <span className="col-span-3 border-2 border-b-0 pl-2 bg-gray-300">
          34. Are you related by consanguinity or affinity to the appointing or
          recommending authority, or to chief of bureau or office or to the
        ...
        {/* THIRD DEGREE */}
        <span className="col-span-3 border-2 border-y-0 pl-2 bg-gray-300">
          a. within the third degree?
        </span>
        <div className="col-span-2 flex gap-12 border-2 border-y-0 pl-4">
          <div className="flex gap-1">
            <input type="checkbox" title="of_third_degree_yes" {...register("of_third_degree_yes")}/>
            <label htmlFor="of_third-degree_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_third_degree_no" {...register("of_third_degree_no")}/>
            <label htmlFor="of_third_degree_no">NO</label>
          </div>
        </div>

        {/* THIRD DEGREE */}
        <span className="col-span-3 border-2 border-t-0 pl-2 bg-gray-300">
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          ...
          <input type="text" id="of_if_yes" className="w-full border-b-2" {...register("of_if_yes")} />
        </div>
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_convicted_yes" {...register("of_convicted_yes")} />
            <label htmlFor="of_convicted_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_convicted_no" {...register("of_convicted_no")} />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_dismissal" {...register("of_dismissal")}/>
            <label htmlFor="of_dismissal_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_dismissal_no" {...register("of_dismissal_no")} />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-b-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_local_candidate_yes" {...register("of_local_candidate_yes")}/>
            <label htmlFor="of_local_candidate_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_local_candidate_no" {...register("of_local_candidate_no")} />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_government_resign_yes" {...register("of_government_resign_yes")} />
            <label htmlFor="of_government_resign_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_government_resign_no" {...register("of_government_resign_no")} />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_acquired_immigrant_yes" {...register("of_acquired_immigrant_yes")} />
            <label htmlFor="of_acquired_immigrant_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_acquired_immigrant_no" {...register("of_acquired_immigrant_no")} />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-y-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_indigenous_yes" {...register("of_indigenous_yes")} />
            <label htmlFor="of_indigenous_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_indigenous_no" {...register("of_indigenous_no")} />
            <label htmlFor="of_indigenous_no">NO</label>
          </div>
          <div className="flex w-full gap-4">
            <label htmlFor="of_if_indigenous_yes">If YES, give details:</label>
            <input
              type="text"
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-y-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_disability_yes" {...register("of_disability_yes")} />
            <label htmlFor="of_disability_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_disability_no" {...register("of_disability_no")} />
            <label htmlFor="of_disability_no">NO</label>
          </div>
          <div className="flex w-full gap-4">
            <label htmlFor="of_if_disability_yes">If YES, give details:</label>
            <input
              type="text"
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_solo_parent_yes" {...register("of_solo_parent_yes")} />
            <label htmlFor="of_solo_parent_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_solo_parent_no" {...register("of_solo_parent_no")} />
            <label htmlFor="of_solo_parent_no">NO</label>
          </div>
          <div className="flex w-full gap-4">
            <label htmlFor="of_if_solo_parent_yes">If YES, give details:</label>
            <input
              type="text"
        ...
        <span className="col-span-4 border-2 pl-2 bg-gray-300">
          41. REFERENCES{" "}
        ...
        <span className="col-span-4 border-2 p-2 text-justify tracking-tighter bg-gray-300">
          ...
          pursuant to the provisions of pertinent laws, rules and regulations of
          the Republic of the Philippines. I authorize the agency
          head/authorized representative to verify/validate the contents stated
          herein. I agree that any misrepresentation made in this document and
          its attachments shall cause the filing of administrative/criminal
          case/s against me.
        </span>
        ...
        <div className="col-span-5 flex justify-between p-4">
          <div className="w-[300px] border-2">
            ...
            <span className="block border-b-2 p-1 text-[.7rem] bg-gray-300">
              Government Issued ID{" "}
            ...
            <div className="flex gap-2 border-b-2 p-1">
              ...
              <input type="text" id="id_no" className="flex-1 text-[.7rem]" {...register("id_no")}/>
            </div>
          ...
          <div className="w-[300px] border-2">
            ...
            <span className="block border-y-2 text-center text-[.7rem] bg-gray-300">
              Signature (Sign inside the box)
            </span>
            <span className="block"> </span>
            <span className="block text-center text-[.7rem] bg-gray-300">
              Date Accomplished
            </span>
          </div>
          ...
          <div className="w-[200px] border-2">
            ...
            <span className="block border-t-2 text-center text-[.7rem] bg-gray-300">
              Right Thumbmark
            </span>
          </div>
        </div>
        ...
        <div className="col-span-5 border-2 p-4">
          <div>
            ...
            <input type="text" title="sworn" className="border-b-2" {...register("sworn")} />
            <span>
          ...
          <div className="mx-auto mt-8 w-[300px] border-2">
            <div className="h-20"></div>
            <span className="block border-t-2 text-center bg-gray-300">
    ...
    <div className="relative h-full flex justify-end items-end p-4">
      <div className="flex items-center gap-4">
        <p className="text-white italic text-sm">CS FORM 212 (Revised 2017), Page 4 of 4</p>
        <button 
        className="flex items-center gap-2 bg-gray-500 rounded-full cursor-pointer p-4">
          <span className="text-white font-semibold">Next</span>
          <img src={arrow} alt="arrow-right" className="w-5 h-5" />
        </button>

        <button
          className="bg-yellow-500 hover:bg-yellow-400 text-white px-7 py-4 rounded-full">
          Save
        </button>
      </div>
    </div>
