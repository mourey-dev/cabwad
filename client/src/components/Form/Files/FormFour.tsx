const FormFour = () => {
  return (
    <form className="mx-auto my-12 grid h-full w-[1001px] border-2">
      <div className="grid grid-cols-5">
        <span className="col-span-3 border-2 border-b-0 pl-2">
        ...
        {/* THIRD DEGREE */}
        <span className="col-span-3 border-2 border-y-0 pl-2">
          a. within the third degree?
        </span>
        <div className="col-span-2 flex gap-12 border-2 border-y-0 pl-4">
          <div className="flex gap-1">
            <input type="checkbox" title="of_third_degree_yes" />
            <label htmlFor="of_third-degree_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_third_degree_no" />
            <label htmlFor="of_third_degree_no">NO</label>
          </div>
        </div>

        {/* THIRD DEGREE */}
        <span className="col-span-3 border-2 border-t-0 pl-2">
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          ...
          <input type="text" id="of_if_yes" className="w-full border-b-2" />
        </div>
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_convicted_yes" />
            <label htmlFor="of_convicted_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_convicted_no" />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_dismissal" />
            <label htmlFor="of_dismissal_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_dismissal_no" />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-b-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_local_candidate_yes" />
            <label htmlFor="of_local_candidate_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_local_candidate_no" />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_government_resign_yes" />
            <label htmlFor="of_government_resign_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_government_resign_no" />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_acquired_immigrant_yes" />
            <label htmlFor="of_acquired_immigrant_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_acquired_immigrant_no" />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-y-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_indigenous_yes" />
            <label htmlFor="of_indigenous_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_indigenous_no" />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-y-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_disability_yes" />
            <label htmlFor="of_disability_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_disability_no" />
        ...
        <div className="col-span-2 flex flex-wrap items-center border-2 border-t-0 px-4 pb-1">
          <div className="mr-12 flex gap-1">
            <input type="checkbox" title="of_solo_parent_yes" />
            <label htmlFor="of_solo_parent_yes">YES</label>
          </div>
          <div className="flex gap-1">
            <input type="checkbox" title="of_solo_parent_no" />
        ...
        <span className="col-span-4 border-2 pl-2">
          41. REFERENCES{" "}
        ...
        <span className="col-span-4 border-2 p-2 text-justify tracking-tighter">
        ...
        <div className="col-span-5 flex justify-between p-4">
          <div className="w-[300px] border-2">
            ...
            <span className="block border-b-2 p-1 text-[.7rem]">
              Government Issued ID{" "}
            ...
            <div className="flex gap-2 border-b-2 p-1">
              ...
              <input type="text" id="id_no" className="flex-1 text-[.7rem]" />
            </div>
          ...
          <div className="w-[300px] border-2">
            ...
            <span className="block border-y-2 text-center text-[.7rem]">
              Signature (Sign inside the box)
            </span>
            <span className="block"> </span>
            <span className="block text-center text-[.7rem]">
              Date Accomplished
            </span>
          </div>
          ...
          <div className="w-[200px] border-2">
            ...
            <span className="block border-t-2 text-center text-[.7rem]">
              Right Thumbmark
            </span>
          </div>
        </div>
        ...
        <div className="col-span-5 border-2 p-4">
          ...
          <div className="mx-auto mt-8 w-[300px] border-2">
            <div className="h-20"></div>
            <span className="block border-t-2 text-center">
